...
-- overgenomen van https://cj.rs/blog/luasnip-and-treesitter-for-smarter-snippets/#clever
...
return {
  ...
  s({ trig = 'ifel', name = 'If Err Log Fatal', dscr = 'Insert a basic if err not nil with log.Fatal' }, {
